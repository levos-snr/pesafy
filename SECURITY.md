...
If you discover a security vulnerability in pesafy, please report it by
emailing:
...
You will receive a response within **48 hours**. If the issue is confirmed, a
patch will be released as soon as possible depending on severity.
...
- The Safaricom Daraja API itself — report those to
